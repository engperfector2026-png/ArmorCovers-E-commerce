...
const Success = () => {
  ...
  useEffect(() => {
    ...
    if (savedTotal) {
      setOrderTotal(parseInt(savedTotal));
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center px-6 py-12">
      <div className="max-w-lg w-full text-center">
        ...
        <h1 className="text-5xl font-bold text-gray-900 mb-3">Order Placed Successfully!</h1>
        <p className="text-green-600 text-xl font-semibold mb-8">Thank you for shopping with ArmorCovers</p>
        
        <div className="bg-white rounded-3xl shadow-sm p-8 mb-10 text-left">
          <h3 className="font-semibold text-lg mb-6 text-center text-gray-800">Order Confirmation</h3>
          ...
          <div className="space-y-5">
            ...
            <div className="border-t pt-6 flex justify-between items-center text-2xl font-bold">
              <span>Total Amount</span>
              <span className="text-green-600">KSh {orderTotal.toLocaleString()}</span>
            </div>
          </div>
        </div>
