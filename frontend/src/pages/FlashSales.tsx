...
function FlashSales() {
  ...
  // Only dates that have flash sale products
  ...
  // Products for the selected date
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="text-center lg:text-left max-w-xl">
              ...
              <p className="text-slate-600 text-base md:text-lg leading-relaxed">
                ...
                <span className="font-semibold text-orange-600">70% off</span>.
              ...
              <div className="flex gap-2.5 md:gap-3">
                {[
                  ...
                  <div key={i} className="flex flex-col items-center">
                    <div className="bg-white rounded-xl w-[72px] h-[72px] md:w-20 md:h-20 flex items-center justify-center border border-orange-200 shadow-sm">
                      <span className="text-2xl md:text-3xl font-bold text-slate-900 font-mono tabular-nums">
                        {pad(item.value)}
                      </span>
                    </div>
                    <span className="text-slate-500 text-[10px] md:text-xs mt-2 font-semibold tracking-widest uppercase">
                      {item.label}
                    </span>
                  </div>
                ))}
              ...
              availableDates.map((dateKey) => {
                ...
                return (
                  <button
                    ...
                    className={`flex-shrink-0 px-4 py-2 text-sm font-medium whitespace-nowrap transition-all rounded-lg ${
                      isActive
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          >
            ...
            {selectedFilters.length > 0 && (
              <span className="bg-orange-600 text-white text-[11px] font-semibold rounded-full w-5 h-5 flex items-center justify-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-white border border-slate-200 rounded-lg px-4 py-2.5 pr-10 text-sm text-slate-700 cursor-pointer hover:border-slate-300 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all"
              >
        ...
        {loading ? (
          ...
          <>
                ...
                return (
                  ...
                  >
                    <div className="absolute top-3 left-3 z-10">
                      <span className="bg-orange-600 text-white text-[11px] font-bold px-2 py-0.5 rounded-md">
                        −{discount}%
                      </span>
                    </div>
                    ...
                    <div className="p-3.5 md:p-4">
                      <span className="inline-flex items-center gap-1 bg-slate-800 text-white text-[10px] font-semibold px-1.5 py-0.5 rounded mb-2">
                        <Check size={9} />
                        Official Store
                      </span>
                      ...
                      <div className="mb-3">
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                          ...
                          <span className="text-[11px] font-medium text-orange-700 bg-orange-50 px-1.5 py-0.5 rounded">
                            Save KSh{" "}
            ...
            <div className="mt-12 text-center">
              <div className="inline-flex flex-col items-center gap-2 bg-white rounded-xl border border-slate-200 px-8 py-5">
