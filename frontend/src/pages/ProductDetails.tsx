              ...
              <div className="relative group">
                <div className="bg-white rounded-3xl shadow p-4 overflow-hidden">
                  {product.image ? (
                    ...
                    <div className="h-[520px] bg-gray-100 rounded-2xl flex items-center justify-center text-8xl">
                      📦
                    </div>
                  )}
                    ...
                    <div className="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-2xl p-5">
                      ...
                      <div className="grid grid-cols-4 gap-3 text-center">
                        <div className="bg-white rounded-xl py-3 shadow-sm">
                          <p className="text-2xl font-bold text-orange-600">{timeLeft.days}</p>
                          <p className="text-xs text-gray-500">Days</p>
                        </div>
                        <div className="bg-white rounded-xl py-3 shadow-sm">
                          <p className="text-2xl font-bold text-orange-600">{timeLeft.hours}</p>
                          <p className="text-xs text-gray-500">Hours</p>
                        </div>
                        <div className="bg-white rounded-xl py-3 shadow-sm">
                          <p className="text-2xl font-bold text-orange-600">{timeLeft.minutes}</p>
                          <p className="text-xs text-gray-500">Mins</p>
                        </div>
                        <div className="bg-white rounded-xl py-3 shadow-sm">
                          <p className="text-2xl font-bold text-orange-600">{timeLeft.seconds}</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {filteredRelated.map((p) => (
              <Link
                ...
                className="bg-white rounded-3xl shadow hover:shadow-xl transition overflow-hidden block group"
              >
